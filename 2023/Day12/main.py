...
if __name__ == "__main__":
    ...
    nr_arr = 0
    for index, arr in enumerate(arrangements):
        print(index+1, end="\r", flush=True)
        report = ReportLine(arr)
        valid_arrangements = report.get_arrangements()
        nr_arr += len(valid_arrangements)

    print("Sum of all possible valid arrangements is:", nr_arr)
