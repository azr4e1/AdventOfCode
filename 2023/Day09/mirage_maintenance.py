...
if __name__ == "__main__":
    ...
    parser = Parser(raw_sequences)
    sequences = parser.parse()
    next_els = [seq.next() for seq in sequences]
    prev_els = [seq.prev() for seq in sequences]

    print("The sum of the extrapolated next values is:", sum(next_els))
    print("The sum of the extrapolated previous values is:", sum(prev_els))
